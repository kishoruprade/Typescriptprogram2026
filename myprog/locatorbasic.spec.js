 ...
 */
(0, test_1.test)('locatorbasic test', async ({ page }) => {
    ...
    //5 Use ot Text
    const forgottenPwdLink = page.locator('text=Forgotten Password');
    ...
    //6 Use of Text
    const emailId = page.locator('input#input-email'); //other way of writing css default is csss 
    // const emailId:Locator = page.locator('css=input#input-email');
    await emailId.fill('SameerPot@gmail.com');
    //7 Use of Test
    const telephone = page.locator('input[name="telephone"]'); //other way of writing css default is css
    // const telephone:Locator = page.locator('css=input[name="telephone"]');
    await telephone.fill('987654310');
    //8 Use of privacy checkbox
    const privacyCheckBox = page.locator('input[type="checkbox"]'); //other way of writing css default is css
    //const privacyCheckBox:Locator = page.locator('css=input[type="checkbox"]');
    await privacyCheckBox.check();
    //9 Use of Xpath
    const password = page.locator('xpath=//input[@id="input-password"]'); // we can use xpath = 
    await password.fill('Kishor@1234');
    //const search:Locator = page.locator('//input[@name="search"]');
    const search = page.locator('//input[@name="search" and @type="text"]'); //we can skip "xpath ="
...
//# sourceMappingURL=locatorbasic.spec.js.map