...
(0, test_1.test)('loginbrowsercontext test', async ({ browser }) => {
    ...
    // Assertions
    (0, test_1.expect)(title1).toBe('My Account');
    (0, test_1.expect)(title2).toBe('My Account');
...
//# sourceMappingURL=loginbrowsercontext.spec.js.map