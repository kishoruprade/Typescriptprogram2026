 ...
 */
(0, test_1.test)('locatorsAdv test', async ({ page }) => {
    ...
    //header
    await (0, test_1.expect)(page.getByRole('heading', { name: 'Register Account' })).toBeVisible();
...
*/
    await (0, test_1.expect)(page.getByRole('link', { name: 'Forgotten Password' })).toBeEnabled();
    await (0, test_1.expect)(page.getByRole('radio', { name: 'yes' })).toBeEnabled(); //case insensitive
    await page.getByRole('radio', { name: 'no' }).click();
    await (0, test_1.expect)(page.getByRole('checkbox')).toBeVisible();
...
//# sourceMappingURL=locatorsAdv.spec.js.map