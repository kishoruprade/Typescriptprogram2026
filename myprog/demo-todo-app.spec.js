...
test_1.test.describe('New Todo', () => {
    (0, test_1.test)('@smoke - should allow me to add todo items ', async ({ page }) => {
...
test_1.test.describe('Mark all as completed', () => {
    ...
    (0, test_1.test)('@smoke - should allow me to mark all items as completed', async ({ page }) => {
        // Complete all todos.
...
test_1.test.describe('Item', () => {
    (0, test_1.test)('@smoke - should allow me to mark items as complete', async ({ page }) => {
        // create a new todo locator
        const newTodo = page.getByPlaceholder('What needs to be done?');
        // Create two items.
...
test_1.test.describe('@smoke - Editing', () => {
    test_1.test.beforeEach(async ({ page }) => {
        await createDefaultTodos(page);
        await checkNumberOfTodosInLocalStorage(page, 3);
    });
...
test_1.test.describe('Counter', () => {
    (0, test_1.test)('@smoke - should display the current number of todo items', async ({ page }) => {
        // create a new todo locator
        const newTodo = page.getByPlaceholder('What needs to be done?');
        // create a todo count locator
        const todoCount = page.getByTestId('todo-count');
...
test_1.test.describe('Clear completed button', () => {
    ...
    (0, test_1.test)('@smoke - should display the correct text', async ({ page }) => {
...
test_1.test.describe('Persistence', () => {
    (0, test_1.test)('@smoke - should persist its data', async ({ page }) => {
        // create a new todo locator
        const newTodo = page.getByPlaceholder('What needs to be done?');
        for (const item of TODO_ITEMS.slice(0, 2)) {
            await newTodo.fill(item);
...
test_1.test.describe('Routing', () => {
    ...
    (0, test_1.test)('@smoke - should allow me to display active items', async ({ page }) => {
